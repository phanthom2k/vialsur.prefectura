    ...
    public class uc_TIPOUSUARIO : ComboBox
    {
        ...
        public void CargarDatos()
        {
            try
            {
                ...
                _dt_catalogo = new logica.vialsur.prefectura.Catalogos.cls_logica_emp_empleado_tipo_usuario().Consultar();
              
                System.Data.DataRow dr0 = _dt_catalogo.NewRow();
                dr0["id"] = 0;
                dr0["nombre"] = "Seleccione";
                _dt_catalogo.Rows.InsertAt(dr0,0);
            ...
            {
                MessageBox.Show("Problemas al cargar el catalogo de tipos de usuarios", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
