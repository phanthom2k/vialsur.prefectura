...
namespace vialsur.prefectura.rpt
{
    ...
    public class cls_RPT_orden_fondo_partes_y_piezas
    {

        public int Orden_Id { get; set; }

        private static string ArchivoFichaUnipropiedad = @"C:\template_fondorotativopartespiezas_v1";

        private static string template_1 = System.Environment.CurrentDirectory + "\\template_fondorotativopartespiezas_v1.pdf";
        ...
        public string Generar()
        {
            try
            {
                ...
                PdfStamper pdfStamper = new PdfStamper(pdfReader, new FileStream(@"C:\Temp\3.pdf", FileMode.Create));
                ...
                DataTable dt_detalle = new logica.vialsur.prefectura.Catalogos.cls_logica_fondo_detalle_pedido().ConsultarDetallesBy_PedidoId(Orden_Id);
