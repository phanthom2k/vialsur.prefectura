...
namespace vialsur.prefectura.rpt
{
    ...
    public class cls_RPT_orden_lubicantes
    {

        public int Orden_Id { get; set; }

        private static string ArchivoFichaUnipropiedad = @"C:\template_orden_lubricantes_v1";

        private static string template_1 = System.Environment.CurrentDirectory + "\\template_orden_lubricantes_v1.pdf";
