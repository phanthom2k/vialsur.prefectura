...
namespace datos.vialsur.prefectura
{
    ...
    public class cls_data_fondo_pedido
    {
     ...
     /////   private string sql_Consulta = "SELECT id, nombre, obserbacion FROM ve_vehiculo_marca where activo=1 order by nombre asc;";
        ...
        public void Insertar(entidades.vialsur.prefectura.fondo_pedido pedido)
        {            
            try
            {
                ...
                string _sql_insert = "INSERT INTO[dbo].[fondo_pedido]([id],[fecha],[cedula],[orden_id],[aprobada]) VALUES(dbo.FUN_FONDOS_PEDIDOS_SEC(),@fecha,@cedula,@orden_id,0); ";                                                         
            ...
            {
                throw new Exception("No se pudo registrar los datos del pedido", ex);
            }                    
        }
        ...
        /// <param name=""></param>
        /// <returns></returns>
        public entidades.vialsur.prefectura.fondo_pedido Consultar_Pedido(string ByOrdenID )
        {
            try
            {

                string consulta = "SELECT [id],[fecha],[cedula],[observaciones],[orden_id],[aprobada] FROM [dbo].[fondo_pedido] WHERE [orden_id] = @orden_id";
