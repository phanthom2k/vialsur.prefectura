...
namespace datos.vialsur.prefectura
{
    ...
    public class cls_data_emp_empleado_tipo_usuario
    {
        private string _con = String.Empty;
        public cls_data_emp_empleado_tipo_usuario()
        {
            this._con = ConfigurationManager.ConnectionStrings["db_mantenimiento"].ConnectionString;
        }
        ~cls_data_emp_empleado_tipo_usuario()
        {
        ...
        /// <summary>
        /// Consulta todo el catalogo de tipo de usuarios disponibles (ID, Nombre)
        /// </summary>
        /// <returns></returns>
        public DataTable Consultar()
        {
            try
            {
                string _sql_consulta = "SELECT[id],[nombre] FROM[dbo].[emp_empleado_tipo_usuario] order by id asc; ";
