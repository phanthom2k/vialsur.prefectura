...
namespace logica.vialsur.prefectura.Catalogos
{
    ...
    public    class cls_logica_fondo_pedido
    {
        ...
        public entidades.vialsur.prefectura.fondo_pedido Consultar_Pedido(string ByOrdenID)
        {
            try
            {
                return new cls_data_fondo_pedido().Consultar_Pedido(ByOrdenID);
        ...
        public void InsertarPedido(entidades.vialsur.prefectura.fondo_pedido pedido)
        {
            try
            {
                new cls_data_fondo_pedido().Insertar(pedido);
