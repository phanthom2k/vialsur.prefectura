...
namespace logica.vialsur.prefectura.Catalogos
{
    ...
    public class cls_logica_detalle_pedidos_aceite
    {
        ...
        public void EliminarDetallePedido(int id)
        {
            try
            {
                new datos.vialsur.prefectura.cls_data_detalle_pedidos_aceite().Eliminar(id);
            }
            catch (Exception ex)
            {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public entidades.vialsur.prefectura.detalle_pedidos_aceite ConsultarDetallePedidoById(int id)
        {
            try
            {
                return new cls_data_detalle_pedidos_aceite().ConsultarDetalleById(id);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataTable ConsultarDetallesByOrden_Id(string orden_id)
        {
            ...
            try
            {
                return new datos.vialsur.prefectura.cls_data_detalle_pedidos_aceite().ConsultarDetallesByOrden_Id(orden_id);
            }
            catch (Exception ex)
            {
        ...
        public DataTable ConsultarDetallesBy_PedidoId(int pedido_id)
        {
            ...
            try
            { 
                return new datos.vialsur.prefectura.cls_data_detalle_pedidos_aceite().ConsultarDetallesBy_PedidoId(pedido_id);
            }
            catch (Exception ex)
            {
                throw new Exception("cls_logica_detalle_pedidos:" + ex.Message, ex);
