...
namespace logica.vialsur.prefectura.Catalogos
{
    ...
    public class cls_logica_emp_empleado_tipo_usuario
    {
        /// <summary>
        ...
        public DataTable Consultar()
        {
            try
            {
                return new datos.vialsur.prefectura.cls_data_emp_empleado_tipo_usuario().Consultar();
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public string Consultar_Nombre_Tipo_Usuario_Por_ID(int i)
        {
            try
            {
                return new datos.vialsur.prefectura.cls_data_emp_empleado_tipo_usuario().Consultar_Nombre_Tipo_Usuario_Por_ID(i);
            }
            catch (Exception ex)
            {
